...
#     return train_losses,val_losses,acces
def train(model, train_loader,valid_loader,epochs, criterion, optimizer,scheduler,device,PATH):
    train_losses = []
    val_losses = []
    acces = []
    early_stopping = EarlyStopping( PATH)
...
def main():
    ...
    optimizer = optim.SGD(net.parameters(), lr=0.008, momentum=0.9, weight_decay=1E-4)
    milestones = [70,150,250,400]
    ...
    PATH = './weights'
    train_losses,val_losses,acces = train(net,train_loader,val_loader,epochs,criterion,optimizer,scheduler,device,PATH)
